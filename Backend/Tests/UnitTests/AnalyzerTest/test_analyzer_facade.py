...
class TestAnalyzerFacade(unittest.TestCase):
    ...
    def test_search_free_text(self):
        ...
        self.facade.information_retrival.search_free_text.return_value = expected_result

        result = self.facade.search_free_text(text)
        self.facade.information_retrival.search_free_text.assert_called_once_with(text=text)
